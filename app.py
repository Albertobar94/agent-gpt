...
def get_current_user(props: HTTPAuthorizationCredentials = Depends(security)):
    credentials = props.credentials
    if credentials == os.getenv("BEARER_TOKEN_KEY"):
        return True
    else:
...
@app.post("/")
def researchAgent(query: Query, current_user = Depends(get_current_user)):
    query = query.query
